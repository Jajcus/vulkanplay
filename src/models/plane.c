...
/* plane vertices */
#define V1 {-1.0f,  0.0f, -1.0f, 1.0f}
#define V2 {-1.0f,  0.0f,  1.0f, 1.0f}
#define V3 { 1.0f,  0.0f,  1.0f, 1.0f}
#define V4 { 1.0f,  0.0f, -1.0f, 1.0f}
...
static const struct vertex_data vertices[VERT_COUNT] = {
	{ V1, NULLVEC, 0, V_FLAG_FLAT }, { V2, NULLVEC, 0, V_FLAG_FLAT }, {V3, NULLVEC, 0, V_FLAG_FLAT },
	{ V1, NULLVEC, 0, V_FLAG_FLAT }, { V3, NULLVEC, 0, V_FLAG_FLAT }, {V4, NULLVEC, 0, V_FLAG_FLAT },
};
...
const struct model_type plane_model_type = {
	.name = "Plane",
};
